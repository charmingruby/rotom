defmodule RotomWeb.UserSessionController do
  ...
  defp create(conn, %{"user" => user_params}, info) do
    ...
    if user = Accounts.get_authenticated_user(email_or_username, password) do
      ...
      # In order to prevent user enumeration attacks, don't disclose whether the email or username is registered.      conn
