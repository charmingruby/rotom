defmodule RotomWeb.ChatRoomLive do
  ...
  alias RotomWeb.ChatRoomLive.ThreadComponent

  import RotomWeb.UserComponents
  import RotomWeb.ChatComponents
  ...
  def handle_event("show-thread", %{"id" => message_id}, socket) do
    ...
    socket = socket |> assign(profile: nil, thread: message)
